	...
	<body>
		<header>
			...
			<nav class="topnav" id="topnav">
		  	  ...
		  	  <a href="${path }jsp/share_knowledge.jsp"><span>资料分享</span><span class="en">Learn</span></a>
		...
		<div class="banner">
			<section class="box">
			    <ul class="texts">
			      ...
			      <p>这就是青春：充满着力量，</p>
			      <p>充满着期待志愿，充满着求知和斗争的志向，</p>
			      <p>充满着希望信心和青春。</br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			      	&nbsp;&nbsp;&nbsp;—— 奥斯特洛夫斯基
			      </p>
			    </ul>
			    <div class="avatar"><a href="#"><span>阮杨斌</span></a> </div>
			</section>
		</div>
		<div class="template">
			<div class="box">
			...
			<article>
			  ...
			  <div class="bloglist left">
				  ...
				  <c:forEach items="${requestScope.titles}" var="title">
				    ...
				    <span>作者：ryb</span><span>阅读量：[<a>${title.title_read }</a>]</span></p>
				  </c:forEach> 
			  </div>
